...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('permissions')->insert([
            ...
            ['name' => 'department-show','note' => 'Xem department'],
            ...
            ['name' => 'project-show','note' => 'Xem project'],
            ['name' => 'project-add','note' => 'Them project'],
            ['name' => 'project-edit','note' => 'Sua project'],
            ['name' => 'project-delete','note' => 'Xoa project'],
            ['name' => 'customer-list','note' => 'Danh sach user'],
            ['name' => 'customer-show','note' => 'Xemcustomer'],
            ...
            ['name' => 'report-show','note' => 'Xem report'],
            ...
            ['name' => 'feedback-show','note' => 'Xem feedback'],
